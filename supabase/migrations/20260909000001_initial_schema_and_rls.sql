...
CREATE POLICY "Profiles insertable by authenticated" ON public.profiles FOR INSERT TO authenticated WITH CHECK (auth.uid() = id OR public.get_current_role() = 'administrator');
