...
export default function DashboardLayout({
  ...
  return (
    <>
      ...
      <div
        className="min-h-screen lg:h-screen bg-cosmic flex flex-col lg:overflow-hidden transition-opacity duration-500"
        style={{ opacity: showSplash ? 0 : 1 }}
      >
        <OfflineBanner />
        <div className="flex flex-1 min-h-0 lg:overflow-hidden">
          {/* Desktop Sidebar */}
          <div className="hidden lg:flex flex-col shrink-0 h-full self-stretch">
            <Sidebar />
          </div>
